            ...
            <section class="sidebar">
                ...
                <!-- Sidebar Menu -->
                    ...
                    <li class="treeview"><a href="/schedules"><i class="fa fa-calendar"></i>  <span>Schedules</span>
                            <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                         <ul class="treeview-menu" style="display: none;">
                            <li><a href="../schedule/create"><i class="fa fa-calendar-plus-o"></i>Set up schedules</a></li>
                            <li><a href="../schedules"><i class="fa fa-calendar-check-o"></i>Pending schedules</a></li>
